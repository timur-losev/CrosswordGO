...
namespace GoogleMobileAds.Editor
{
    ...
    {
        private const string MobileAdsSettingsDir = "Assets/WordChef/GoogleMobileAds";

        private const string MobileAdsSettingsResDir = "Assets/WordChef/GoogleMobileAds/Resources";

        private const string MobileAdsSettingsFile =
            "Assets/WordChef/GoogleMobileAds/Resources/GoogleMobileAdsSettings.asset";
